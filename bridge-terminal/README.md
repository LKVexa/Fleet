...
## Harbor integration release 2.1.0-cubby.2

The current Harbor-integrated release retains the R28 `2.0.0-ramws.1` experiment as historical evidence while advancing the package to `2.1.0-cubby.2`. The release adds Cubby/Bottle Rocket mobile projection and closes review findings around manifest sealing, deterministic test execution, v2 benchmark metadata, backend-aware worker memory telemetry, and host-aware `brctl serve` startup. See `../docs/RELEASE_2.1.0_CUBBY.1.md`.
