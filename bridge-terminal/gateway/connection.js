...
class Connection {
  ...
  _open(msg) {
    ...
    const env = { PATH: process.env.PATH || '', VWS_W_CONN: this.id, VWS_W_BACKEND: cfg.workerBackend, VWS_W_VFS_BYTES: String(cfg.vfsBytes), VWS_W_VFS_NODES: String(cfg.vfsNodes), VWS_W_PENDING_BYTES: String(cfg.workerPendingBytes), VWS_W_CAPTURE_BYTES: String(cfg.captureBytes), VWS_W_HISTORY_ENTRIES: String(cfg.historyEntries) };
