...
// Tests are side-effect free by default. The production mobile-auth hook writes Cubby
// allocation/evidence records under HARBOR_ROOT; dedicated mobile integration tests may
// explicitly opt in by setting HARBOR_MOBILE_AUTH_HOOK=1 before this helper is loaded.
if (process.env.HARBOR_MOBILE_AUTH_HOOK === undefined) process.env.HARBOR_MOBILE_AUTH_HOOK = '0';
