...
2. **HERMIT / SPIRAL bridge-terminal** (`bridge-terminal/`, package `hermit-spiral-terminal` **2.1.0-cubby.2**) — virtual terminal + RAM-resident virtual WebSocket (RAMWS) gateway on loopback.
